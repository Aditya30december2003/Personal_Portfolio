...
const [counterOn ,setCounterOn]=useState(false)
  return (
    ...
    <div className='shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] w-[90%] lg:w-[100%] rounded-[1rem] max-w-[1080px] mx-auto mt-32 flex-col flex justify-between sm:flex sm:flex-row gap-10 p-5 bg-white'>
      <div className='left flex flex-col gap-2 md:flex-row mx-auto md:mx-0 sm:w-[50%] md:w-[25%] lg:w-[20%] justify-between'>
        ...
        <div>
            <h1 className='text-[1.7rem] md:text-[1.3rem] font-bold'>{counterOn && <CountUp start={0} end={2} duration={2} delay={0} />}+ Years of</h1>
